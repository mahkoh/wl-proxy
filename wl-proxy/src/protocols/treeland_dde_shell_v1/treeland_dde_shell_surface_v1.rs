...
impl ConcreteObject for TreelandDdeShellSurfaceV1 {
    const XML_VERSION: u32 = 1;
    const INTERFACE: ObjectInterface = ObjectInterface::TreelandDdeShellSurfaceV1;
    const INTERFACE_NAME: &str = "treeland_dde_shell_surface_v1";
}
