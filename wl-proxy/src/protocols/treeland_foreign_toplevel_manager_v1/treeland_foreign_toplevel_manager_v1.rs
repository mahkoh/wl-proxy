...
impl ConcreteObject for TreelandForeignToplevelManagerV1 {
    const XML_VERSION: u32 = 1;
    const INTERFACE: ObjectInterface = ObjectInterface::TreelandForeignToplevelManagerV1;
    const INTERFACE_NAME: &str = "treeland_foreign_toplevel_manager_v1";
}
...
impl TreelandForeignToplevelManagerV1 {
    ...
    pub fn try_send_get_dock_preview_context(
        ...
        let arg0_id = match arg0.server_obj_id.get() {
            None => return Err(ObjectError(ObjectErrorKind::ArgNoServerId("relative_surface"))),
            Some(id) => id,
        };
        ...
        match msg[1] & 0xffff {
            ...
            1 => {
                ...
                let Ok(arg0) = (arg0 as Rc<dyn Any>).downcast::<WlSurface>() else {
                    ...
                    return Err(ObjectError(ObjectErrorKind::WrongObjectType("relative_surface", o.core().interface, ObjectInterface::WlSurface)));
                };
                let arg1_id = arg1;
