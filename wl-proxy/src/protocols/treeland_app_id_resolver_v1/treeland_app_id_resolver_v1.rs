...
pub trait TreelandAppIdResolverV1Handler: Any {
    ...
    fn handle_identify_request(
        ...
        if let Err(e) = res {
            log::warn!("Could not forward a treeland_app_id_resolver_v1.identify_request message: {}", Report::new(e));
        }
    }
    ...
    fn handle_respond(
        ...
        if let Err(e) = res {
            log::warn!("Could not forward a treeland_app_id_resolver_v1.respond message: {}", Report::new(e));
        }
    }
    ...
    fn handle_destroy(
        ...
        if let Err(e) = res {
            log::warn!("Could not forward a treeland_app_id_resolver_v1.destroy message: {}", Report::new(e));
        }
    }
}
