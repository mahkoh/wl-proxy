        ...
        match msg[1] & 0xffff {
            0 => {
                ...
                if let Some(handler) = handler {
                    (**handler).respond(&self, arg0, arg1, arg2);
                } else {
                    DefaultHandler.respond(&self, arg0, arg1, arg2);
                }
            }
            1 => {
                if msg.len() != 2 {
    ...
    fn handle_event(self: Rc<Self>, msg: &[u32], fds: &mut VecDeque<Rc<OwnedFd>>) -> Result<(), ObjectError> {
        ...
        match msg[1] & 0xffff {
            0 => {
                ...
                if let Some(handler) = handler {
                    (**handler).identify_request(&self, arg0, arg1);
                } else {
                    DefaultHandler.identify_request(&self, arg0, arg1);
                }
            }
            n => {
                let _ = msg;
