...
/// A treeland_app_id_resolver_manager_v1 proxy.
///
...
impl TreelandAppIdResolverManagerV1 {
    ...
    pub const INTERFACE: ProxyInterface = ProxyInterface::TreelandAppIdResolverManagerV1;
...
impl ProxyPrivate for TreelandAppIdResolverManagerV1 {
    fn new(state: &Rc<State>, version: u32) -> Rc<Self> {
        Rc::<Self>::new_cyclic(|slf| Self {
            core: ProxyCore::new(state, slf.clone(), ProxyInterface::TreelandAppIdResolverManagerV1, version),
...
impl Proxy for TreelandAppIdResolverManagerV1 {
