...
impl ExtDataControlOfferV1 {
    pub fn set_handler(&self, handler: impl ExtDataControlOfferV1Handler + 'static) {
...
impl ProxyPrivate for ExtDataControlOfferV1 {
    fn new(state: &Rc<State>, version: u32) -> Rc<Self> {
        Rc::<Self>::new_cyclic(|slf| Self {
            core: ProxyCore::new(state, slf.clone(), ProxyInterface::ExtDataControlOfferV1, version),
