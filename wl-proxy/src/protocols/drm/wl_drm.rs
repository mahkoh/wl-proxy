...
impl WlDrm {
    pub fn set_handler(&self, handler: impl WlDrmHandler + 'static) {
        ...
        match msg[1] & 0xffff {
            ...
            2 => {
                let [
                    ...
                    return Err(ObjectError::WrongMessageSize(msg.len() as u32 * 4, 52));
                };
                let arg2 = arg2 as i32;
                let arg3 = arg3 as i32;
            ...
            3 => {
                ...
                let Some(arg1) = fds.pop_front() else {
                    return Err(ObjectError::MissingFd("name"));
                };
                let arg1 = &arg1;
                let arg2 = arg2 as i32;
                let arg3 = arg3 as i32;
