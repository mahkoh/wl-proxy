...
/// A treeland_shortcut_manager_v2 object.
///
...
impl ConcreteObject for TreelandShortcutManagerV2 {
    const XML_VERSION: u32 = 1;
    const INTERFACE: ObjectInterface = ObjectInterface::TreelandShortcutManagerV2;
    const INTERFACE_NAME: &str = "treeland_shortcut_manager_v2";
}

impl TreelandShortcutManagerV2 {
    /// Sets a new handler.
    pub fn set_handler(&self, handler: impl TreelandShortcutManagerV2Handler) {
...
impl TreelandShortcutManagerV2 {
    ...
    pub fn try_send_bind_key(
        ...
        if self.core.state.log {
            #[cold]
            fn log(state: &State, id: u32, arg0: &str, arg1: &str, arg2: TreelandShortcutManagerV2KeybindMode, arg3: TreelandShortcutManagerV2Action) {
                let (millis, micros) = time_since_epoch();
                let prefix = &state.log_prefix;
    ...
    pub fn try_send_bind_swipe_gesture(
        ...
        if self.core.state.log {
            #[cold]
            fn log(state: &State, id: u32, arg0: &str, arg1: u32, arg2: TreelandShortcutManagerV2Direction, arg3: TreelandShortcutManagerV2Action) {
                let (millis, micros) = time_since_epoch();
                let prefix = &state.log_prefix;
    ...
    pub fn try_send_bind_hold_gesture(
        ...
        if self.core.state.log {
            #[cold]
            fn log(state: &State, id: u32, arg0: &str, arg1: u32, arg2: TreelandShortcutManagerV2Action) {
                let (millis, micros) = time_since_epoch();
                let prefix = &state.log_prefix;
    ...
    pub fn try_send_commit_failure(
        ...
        if self.core.state.log {
            #[cold]
            fn log(state: &State, client_id: u64, id: u32, arg0: &str, arg1: TreelandShortcutManagerV2BindError) {
                let (millis, micros) = time_since_epoch();
                let prefix = &state.log_prefix;
...
impl ObjectPrivate for TreelandShortcutManagerV2 {
    fn new(state: &Rc<State>, version: u32) -> Rc<Self> {
        Rc::<Self>::new_cyclic(|slf| Self {
            core: ObjectCore::new(state, slf.clone(), ObjectInterface::TreelandShortcutManagerV2, version),
    ...
    fn handle_request(self: Rc<Self>, client: &Rc<Client>, msg: &[u32], fds: &mut VecDeque<Rc<OwnedFd>>) -> Result<(), ObjectError> {
        ...
        match msg[1] & 0xffff {
            ...
            2 => {
                ...
                let arg1;
                (arg1, offset) = parse_string::<NonNullString>(msg, offset, "key")?;
                let Some(&arg2) = msg.get(offset) else {
                    return Err(ObjectError(ObjectErrorKind::MissingArgument("mode")));
                };
                offset += 1;
                let Some(&arg3) = msg.get(offset) else {
                    return Err(ObjectError(ObjectErrorKind::MissingArgument("action")));
                };
                offset += 1;
                if offset != msg.len() {
                ...
                if self.core.state.log {
                    #[cold]
                    fn log(state: &State, client_id: u64, id: u32, arg0: &str, arg1: &str, arg2: TreelandShortcutManagerV2KeybindMode, arg3: TreelandShortcutManagerV2Action) {
                        let (millis, micros) = time_since_epoch();
                        let prefix = &state.log_prefix;
            ...
            3 => {
                ...
                let Some(&arg1) = msg.get(offset) else {
                    return Err(ObjectError(ObjectErrorKind::MissingArgument("finger")));
                };
                offset += 1;
                let Some(&arg2) = msg.get(offset) else {
                ...
                if self.core.state.log {
                    #[cold]
                    fn log(state: &State, client_id: u64, id: u32, arg0: &str, arg1: u32, arg2: TreelandShortcutManagerV2Direction, arg3: TreelandShortcutManagerV2Action) {
                        let (millis, micros) = time_since_epoch();
                        let prefix = &state.log_prefix;
            ...
            4 => {
                ...
                if self.core.state.log {
                    #[cold]
                    fn log(state: &State, client_id: u64, id: u32, arg0: &str, arg1: u32, arg2: TreelandShortcutManagerV2Action) {
                        let (millis, micros) = time_since_epoch();
                        let prefix = &state.log_prefix;
    ...
    fn handle_event(self: Rc<Self>, server: &Endpoint, msg: &[u32], fds: &mut VecDeque<Rc<OwnedFd>>) -> Result<(), ObjectError> {
        ...
        match msg[1] & 0xffff {
            0 => {
                ...
                (arg0, offset) = parse_string::<NonNullString>(msg, offset, "name")?;
                let Some(&arg1) = msg.get(offset) else {
                    return Err(ObjectError(ObjectErrorKind::MissingArgument("repeat")));
                };
                offset += 1;
                if offset != msg.len() {
                    return Err(ObjectError(ObjectErrorKind::TrailingBytes));
            ...
            2 => {
                ...
                (arg0, offset) = parse_string::<NonNullString>(msg, offset, "name")?;
                let Some(&arg1) = msg.get(offset) else {
                    return Err(ObjectError(ObjectErrorKind::MissingArgument("error")));
                };
                offset += 1;
                if offset != msg.len() {
                    return Err(ObjectError(ObjectErrorKind::TrailingBytes));
                ...
                if self.core.state.log {
                    #[cold]
                    fn log(state: &State, id: u32, arg0: &str, arg1: TreelandShortcutManagerV2BindError) {
                        let (millis, micros) = time_since_epoch();
                        let prefix = &state.log_prefix;
...
impl Object for TreelandShortcutManagerV2 {
