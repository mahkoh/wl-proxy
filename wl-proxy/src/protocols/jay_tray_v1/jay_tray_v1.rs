...
impl JayTrayV1 {
    pub fn set_handler(&self, handler: impl JayTrayV1Handler + 'static) {
...
impl ProxyPrivate for JayTrayV1 {
    fn new(state: &Rc<State>, version: u32) -> Rc<Self> {
        Rc::<Self>::new_cyclic(|slf| Self {
            core: ProxyCore::new(state, slf.clone(), ProxyInterface::JayTrayV1, version),
