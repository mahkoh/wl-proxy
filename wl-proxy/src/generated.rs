...
#[cfg(feature = "protocol-treeland_capture_unstable_v1")]
...
mod all_types {
    ...
    #[cfg(feature = "protocol-treeland_capture_unstable_v1")]
    pub(super) use super::treeland_capture_unstable_v1::treeland_capture_context_v1::TreelandCaptureContextV1;
    #[cfg(feature = "protocol-treeland_capture_unstable_v1")]
    pub(super) use super::treeland_capture_unstable_v1::treeland_capture_context_v1::TreelandCaptureContextV1SourceType;
    #[cfg(feature = "protocol-treeland_capture_unstable_v1")]
    pub(super) use super::treeland_capture_unstable_v1::treeland_capture_context_v1::TreelandCaptureContextV1SourceFailure;
    #[cfg(feature = "protocol-treeland_capture_unstable_v1")]
    pub(super) use super::treeland_capture_unstable_v1::treeland_capture_frame_v1::TreelandCaptureFrameV1;
    #[cfg(feature = "protocol-treeland_capture_unstable_v1")]
    pub(super) use super::treeland_capture_unstable_v1::treeland_capture_frame_v1::TreelandCaptureFrameV1Flags;
    #[cfg(feature = "protocol-treeland_capture_unstable_v1")]
    pub(super) use super::treeland_capture_unstable_v1::treeland_capture_manager_v1::TreelandCaptureManagerV1;
    #[cfg(feature = "protocol-treeland_capture_unstable_v1")]
    pub(super) use super::treeland_capture_unstable_v1::treeland_capture_session_v1::TreelandCaptureSessionV1;
    #[cfg(feature = "protocol-treeland_capture_unstable_v1")]
    pub(super) use super::treeland_capture_unstable_v1::treeland_capture_session_v1::TreelandCaptureSessionV1CancelReason;
    #[cfg(feature = "protocol-treeland_capture_unstable_v1")]
    pub(super) use super::treeland_capture_unstable_v1::treeland_capture_session_v1::TreelandCaptureSessionV1Flags;
    #[cfg(feature = "protocol-treeland_dde_shell_v1")]
    ...
    pub(super) fn proxy_interface(interface: &str) -> Option<ProxyInterface> {
        static INTERFACES: phf::Map<&'static str, Option<ProxyInterface>> = phf::phf_map! {
            ...
            "treeland_capture_context_v1" => {
                #[cfg(feature = "protocol-treeland_capture_unstable_v1")] { Some(ProxyInterface::TreelandCaptureContextV1) }
                #[cfg(not(feature = "protocol-treeland_capture_unstable_v1"))] { None }
            },
            "treeland_capture_frame_v1" => {
                #[cfg(feature = "protocol-treeland_capture_unstable_v1")] { Some(ProxyInterface::TreelandCaptureFrameV1) }
                #[cfg(not(feature = "protocol-treeland_capture_unstable_v1"))] { None }
            },
            "treeland_capture_manager_v1" => {
                #[cfg(feature = "protocol-treeland_capture_unstable_v1")] { Some(ProxyInterface::TreelandCaptureManagerV1) }
                #[cfg(not(feature = "protocol-treeland_capture_unstable_v1"))] { None }
            },
            "treeland_capture_session_v1" => {
                #[cfg(feature = "protocol-treeland_capture_unstable_v1")] { Some(ProxyInterface::TreelandCaptureSessionV1) }
                #[cfg(not(feature = "protocol-treeland_capture_unstable_v1"))] { None }
            },
    ...
    impl ProxyInterface {
        fn create_proxy(self, state: &Rc<State>, version: u32) -> Result<Rc<dyn Proxy>, ObjectError> {
            match self {
                ...
                #[cfg(feature = "protocol-treeland_capture_unstable_v1")]
                Self::TreelandCaptureContextV1 => {
                    if version > TreelandCaptureContextV1::XML_VERSION {
                        return Err(ObjectError::MaxVersion(self, version));
                    }
                    Ok(TreelandCaptureContextV1::new(state, version))
                }
                #[cfg(feature = "protocol-treeland_capture_unstable_v1")]
                Self::TreelandCaptureFrameV1 => {
                    if version > TreelandCaptureFrameV1::XML_VERSION {
                        return Err(ObjectError::MaxVersion(self, version));
                    }
                    Ok(TreelandCaptureFrameV1::new(state, version))
                }
                #[cfg(feature = "protocol-treeland_capture_unstable_v1")]
                Self::TreelandCaptureManagerV1 => {
                    if version > TreelandCaptureManagerV1::XML_VERSION {
                        return Err(ObjectError::MaxVersion(self, version));
                    }
                    Ok(TreelandCaptureManagerV1::new(state, version))
                }
                #[cfg(feature = "protocol-treeland_capture_unstable_v1")]
                Self::TreelandCaptureSessionV1 => {
                    if version > TreelandCaptureSessionV1::XML_VERSION {
                        return Err(ObjectError::MaxVersion(self, version));
                    }
                    Ok(TreelandCaptureSessionV1::new(state, version))
                }
                #[cfg(feature = "protocol-treeland_dde_shell_v1")]
...
pub enum ProxyInterface {
    ...
    #[cfg(feature = "protocol-treeland_capture_unstable_v1")]
    TreelandCaptureContextV1,
    #[cfg(feature = "protocol-treeland_capture_unstable_v1")]
    TreelandCaptureFrameV1,
    #[cfg(feature = "protocol-treeland_capture_unstable_v1")]
    TreelandCaptureManagerV1,
    #[cfg(feature = "protocol-treeland_capture_unstable_v1")]
    TreelandCaptureSessionV1,
    #[cfg(feature = "protocol-treeland_dde_shell_v1")]
    TreelandDdeActiveV1,
    #[cfg(feature = "protocol-treeland_dde_shell_v1")]
...
impl ProxyInterface {
    pub fn name(self) -> &'static str {
        match self {
            ...
            #[cfg(feature = "protocol-treeland_capture_unstable_v1")]
            Self::TreelandCaptureContextV1 => "treeland_capture_context_v1",
            #[cfg(feature = "protocol-treeland_capture_unstable_v1")]
            Self::TreelandCaptureFrameV1 => "treeland_capture_frame_v1",
            #[cfg(feature = "protocol-treeland_capture_unstable_v1")]
            Self::TreelandCaptureManagerV1 => "treeland_capture_manager_v1",
            #[cfg(feature = "protocol-treeland_capture_unstable_v1")]
            Self::TreelandCaptureSessionV1 => "treeland_capture_session_v1",
            #[cfg(feature = "protocol-treeland_dde_shell_v1")]
    ...
    pub fn xml_version(self) -> u32 {
        match self {
            ...
            #[cfg(feature = "protocol-treeland_capture_unstable_v1")]
            Self::TreelandCaptureContextV1 => 1,
            #[cfg(feature = "protocol-treeland_capture_unstable_v1")]
            Self::TreelandCaptureFrameV1 => 1,
            #[cfg(feature = "protocol-treeland_capture_unstable_v1")]
            Self::TreelandCaptureManagerV1 => 1,
            #[cfg(feature = "protocol-treeland_capture_unstable_v1")]
            Self::TreelandCaptureSessionV1 => 1,
            #[cfg(feature = "protocol-treeland_dde_shell_v1")]
