...
impl MetaZwlrDataControlSourceV1 {
    pub(crate) fn new(state: &Rc<InnerState>, version: u32) -> Rc<Self> {
        Rc::new(Self {
            core: ProxyCore::new(state, ProxyInterface::ZwlrDataControlSourceV1, version),
...
impl MetaZwlrDataControlSourceV1 {
    ...
    pub fn send_offer(
        ...
        eprintln!("server      <= zwlr_data_control_source_v1#{}.offer(mime_type: {:?})", id, arg0);
    ...
    pub fn send_destroy(
        ...
        eprintln!("server      <= zwlr_data_control_source_v1#{}.destroy()", id);
        let endpoint = &self.core.state.server;
        if !endpoint.has_outgoing.replace(true) {
            self.core.state.flushable_endpoints.borrow_mut().push(endpoint.clone());
        }
    ...
    pub fn send_send(
        ...
        eprintln!("client#{:04} <= zwlr_data_control_source_v1#{}.send(mime_type: {:?}, fd: {})", client.endpoint.id, id, arg0, arg1.as_raw_fd());
    ...
    pub fn send_cancelled(
        ...
        let id = core.client_obj_id.get().unwrap_or(0);
        eprintln!("client#{:04} <= zwlr_data_control_source_v1#{}.cancelled()", client.endpoint.id, id);
        let endpoint = &client.endpoint;
        if !endpoint.has_outgoing.replace(true) {
            self.core.state.flushable_endpoints.borrow_mut().push(endpoint.clone());
        }
    ...
    fn handle_request(self: Rc<Self>, client: &Rc<Client>, msg: &[u32], fds: &mut VecDeque<Rc<OwnedFd>>) -> Result<(), ObjectError> {
        ...
        match msg[1] & 0xffff {
            0 => {
                ...
                eprintln!("client#{:04} -> zwlr_data_control_source_v1#{}.offer(mime_type: {:?})", client.endpoint.id, msg[0], arg0);
            ...
            1 => {
                ...
                eprintln!("client#{:04} -> zwlr_data_control_source_v1#{}.destroy()", client.endpoint.id, msg[0]);
                if let Some(handler) = handler {
    ...
    fn handle_event(self: Rc<Self>, msg: &[u32], fds: &mut VecDeque<Rc<OwnedFd>>) -> Result<(), ObjectError> {
        ...
        match msg[1] & 0xffff {
            0 => {
                ...
                let arg1 = &arg1;
                eprintln!("server      -> zwlr_data_control_source_v1#{}.send(mime_type: {:?}, fd: {})", msg[0], arg0, arg1.as_raw_fd());
                if let Some(handler) = handler {
            ...
            1 => {
                ...
                eprintln!("server      -> zwlr_data_control_source_v1#{}.cancelled()", msg[0]);
                if let Some(handler) = handler {
