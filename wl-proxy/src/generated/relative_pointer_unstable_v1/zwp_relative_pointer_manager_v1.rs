...
impl MetaZwpRelativePointerManagerV1 {
    ...
    pub fn send_destroy(
        ...
        eprintln!("server      <= zwp_relative_pointer_manager_v1#{}.destroy()", id);
    ...
    pub fn send_get_relative_pointer(
        ...
        eprintln!("server      <= zwp_relative_pointer_manager_v1#{}.get_relative_pointer(id: zwp_relative_pointer_v1#{}, pointer: wl_pointer#{})", id, arg0_id, arg1_id);
        let endpoint = &self.core.state.server;
        if !endpoint.has_outgoing.replace(true) {
            self.core.state.flushable_endpoints.borrow_mut().push(endpoint.clone());
        }
    ...
    fn handle_request(self: Rc<Self>, client: &Rc<Client>, msg: &[u32], fds: &mut VecDeque<Rc<OwnedFd>>) -> Result<(), ObjectError> {
        ...
        match msg[1] & 0xffff {
            0 => {
                ...
                eprintln!("client#{:04} -> zwp_relative_pointer_manager_v1#{}.destroy()", client.endpoint.id, msg[0]);
            ...
            1 => {
                ...
                eprintln!("client#{:04} -> zwp_relative_pointer_manager_v1#{}.get_relative_pointer(id: zwp_relative_pointer_v1#{}, pointer: wl_pointer#{})", client.endpoint.id, msg[0], arg0, arg1);
                let arg0_id = arg0;
