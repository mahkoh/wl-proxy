...
impl HyprlandFocusGrabManagerV1 {
    pub fn set_handler(&self, handler: impl HyprlandFocusGrabManagerV1Handler + 'static) {
...
impl HyprlandFocusGrabManagerV1 {
    ...
    pub fn send_create_grab(
        ...
        arg0.generate_server_id(arg0_obj.clone())
            .map_err(|e| ObjectError::GenerateServerId("grab", e))?;
        ...
        match msg[1] & 0xffff {
            0 => {
                ...
                arg0.core().set_client_id(client, arg0_id, arg0.clone())
                    .map_err(|e| ObjectError::SetClientId(arg0_id, "grab", e))?;
                let arg0 = &arg0;
                if let Some(handler) = handler {
                    (**handler).create_grab(&self, arg0);
                } else {
                    DefaultHandler.create_grab(&self, arg0);
                }
            }
            1 => {
                if msg.len() != 2 {
