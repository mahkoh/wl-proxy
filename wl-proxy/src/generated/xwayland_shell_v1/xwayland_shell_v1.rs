...
pub struct MetaXwaylandShellV1 {
    core: ProxyCore,
    handler: MessageHandlerHolder<dyn MetaXwaylandShellV1MessageHandler>,
}

struct DefaultMessageHandler;

impl MetaXwaylandShellV1MessageHandler for DefaultMessageHandler { }

impl MetaXwaylandShellV1 {
...
impl MetaXwaylandShellV1 {
    pub(crate) fn new(state: &Rc<InnerState>, version: u32) -> Rc<Self> {
        Rc::new(Self {
            core: ProxyCore::new(state, ProxyInterface::XwaylandShellV1, version),
            handler: Default::default(),
        })
    }
}

impl Debug for MetaXwaylandShellV1 {
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        f.debug_struct("MetaXwaylandShellV1")
...
impl MetaXwaylandShellV1 {
    ...
    pub fn send_destroy(
        ...
        eprintln!("server      <= xwayland_shell_v1#{}.destroy()", id);
    ...
    pub fn send_get_xwayland_surface(
        ...
        eprintln!("server      <= xwayland_shell_v1#{}.get_xwayland_surface(id: xwayland_surface_v1#{}, surface: wl_surface#{})", id, arg0_id, arg1_id);
        let endpoint = &self.core.state.server;
        if !endpoint.has_outgoing.replace(true) {
            self.core.state.flushable_endpoints.borrow_mut().push(endpoint.clone());
        }
...
#[allow(dead_code)]
pub trait MetaXwaylandShellV1MessageHandler {
    /// destroy the Xwayland shell object
    ///
    /// Destroy the xwayland_shell_v1 object.
    ///
...
impl Proxy for MetaXwaylandShellV1 {
    ...
    fn handle_request(self: Rc<Self>, client: &Rc<Client>, msg: &[u32], fds: &mut VecDeque<Rc<OwnedFd>>) -> Result<(), ObjectError> {
        ...
        match msg[1] & 0xffff {
            0 => {
                ...
                eprintln!("client#{:04} -> xwayland_shell_v1#{}.destroy()", client.endpoint.id, msg[0]);
            ...
            1 => {
                ...
                eprintln!("client#{:04} -> xwayland_shell_v1#{}.get_xwayland_surface(id: xwayland_surface_v1#{}, surface: wl_surface#{})", client.endpoint.id, msg[0], arg0, arg1);
                let arg0_id = arg0;
                let arg0 = MetaXwaylandSurfaceV1::new(&self.core.state, self.core.version);
                ...
                if let Some(handler) = handler {
                    ...
                    DefaultMessageHandler.get_xwayland_surface(&self, arg0, arg1);
                }
            }
            n => {
                let _ = client;
...
#[allow(dead_code)]
pub struct MetaXwaylandShellV1Error(pub u32);

impl MetaXwaylandShellV1Error {
    /// given wl_surface has another role
    #[allow(dead_code)]
    pub const ROLE: Self = Self(0);
}

impl Debug for MetaXwaylandShellV1Error {
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        let name = match *self {
            Self::ROLE => "ROLE",
