...
impl MetaXdgToplevelIconManagerV1 {
    ...
    pub fn send_destroy(
        ...
        eprintln!("server      <= xdg_toplevel_icon_manager_v1#{}.destroy()", id);
    ...
    pub fn send_create_icon(
        ...
        eprintln!("server      <= xdg_toplevel_icon_manager_v1#{}.create_icon(id: xdg_toplevel_icon_v1#{})", id, arg0_id);
        let endpoint = &self.core.state.server;
        if !endpoint.has_outgoing.replace(true) {
            self.core.state.flushable_endpoints.borrow_mut().push(endpoint.clone());
        }
    ...
    pub fn send_set_icon(
        ...
        eprintln!("server      <= xdg_toplevel_icon_manager_v1#{}.set_icon(toplevel: xdg_toplevel#{}, icon: xdg_toplevel_icon_v1#{})", id, arg0_id, arg1_id);
        let endpoint = &self.core.state.server;
        if !endpoint.has_outgoing.replace(true) {
            self.core.state.flushable_endpoints.borrow_mut().push(endpoint.clone());
        }
    ...
    pub fn send_icon_size(
        ...
        eprintln!("client#{:04} <= xdg_toplevel_icon_manager_v1#{}.icon_size(size: {})", client.endpoint.id, id, arg0);
    ...
    pub fn send_done(
        ...
        let id = core.client_obj_id.get().unwrap_or(0);
        eprintln!("client#{:04} <= xdg_toplevel_icon_manager_v1#{}.done()", client.endpoint.id, id);
        let endpoint = &client.endpoint;
        if !endpoint.has_outgoing.replace(true) {
            self.core.state.flushable_endpoints.borrow_mut().push(endpoint.clone());
        }
    ...
    fn handle_request(self: Rc<Self>, client: &Rc<Client>, msg: &[u32], fds: &mut VecDeque<Rc<OwnedFd>>) -> Result<(), ObjectError> {
        ...
        match msg[1] & 0xffff {
            0 => {
                ...
                eprintln!("client#{:04} -> xdg_toplevel_icon_manager_v1#{}.destroy()", client.endpoint.id, msg[0]);
            ...
            1 => {
                ...
                eprintln!("client#{:04} -> xdg_toplevel_icon_manager_v1#{}.create_icon(id: xdg_toplevel_icon_v1#{})", client.endpoint.id, msg[0], arg0);
                let arg0_id = arg0;
            ...
            2 => {
                ...
                eprintln!("client#{:04} -> xdg_toplevel_icon_manager_v1#{}.set_icon(toplevel: xdg_toplevel#{}, icon: xdg_toplevel_icon_v1#{})", client.endpoint.id, msg[0], arg0, arg1);
                let arg0_id = arg0;
    ...
    fn handle_event(self: Rc<Self>, msg: &[u32], fds: &mut VecDeque<Rc<OwnedFd>>) -> Result<(), ObjectError> {
        ...
        match msg[1] & 0xffff {
            0 => {
                ...
                eprintln!("server      -> xdg_toplevel_icon_manager_v1#{}.icon_size(size: {})", msg[0], arg0);
                if let Some(handler) = handler {
            ...
            1 => {
                ...
                eprintln!("server      -> xdg_toplevel_icon_manager_v1#{}.done()", msg[0]);
                if let Some(handler) = handler {
                    (**handler).done(&self);
                } else {
