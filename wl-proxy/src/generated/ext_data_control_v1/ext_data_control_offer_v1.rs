...
impl MetaExtDataControlOfferV1 {
    pub(crate) fn new(state: &Rc<InnerState>, version: u32) -> Rc<Self> {
        Rc::new(Self {
            core: ProxyCore::new(state, ProxyInterface::ExtDataControlOfferV1, version),
...
impl MetaExtDataControlOfferV1 {
    ...
    pub fn send_receive(
        ...
        eprintln!("server      <= ext_data_control_offer_v1#{}.receive(mime_type: {:?}, fd: {})", id, arg0, arg1.as_raw_fd());
    ...
    pub fn send_destroy(
        ...
        eprintln!("server      <= ext_data_control_offer_v1#{}.destroy()", id);
        let endpoint = &self.core.state.server;
        if !endpoint.has_outgoing.replace(true) {
            self.core.state.flushable_endpoints.borrow_mut().push(endpoint.clone());
        }
    ...
    pub fn send_offer(
        ...
        eprintln!("client#{:04} <= ext_data_control_offer_v1#{}.offer(mime_type: {:?})", client.endpoint.id, id, arg0);
    ...
    fn handle_request(self: Rc<Self>, client: &Rc<Client>, msg: &[u32], fds: &mut VecDeque<Rc<OwnedFd>>) -> Result<(), ObjectError> {
        ...
        match msg[1] & 0xffff {
            0 => {
                ...
                let arg1 = &arg1;
                eprintln!("client#{:04} -> ext_data_control_offer_v1#{}.receive(mime_type: {:?}, fd: {})", client.endpoint.id, msg[0], arg0, arg1.as_raw_fd());
            ...
            1 => {
                ...
                eprintln!("client#{:04} -> ext_data_control_offer_v1#{}.destroy()", client.endpoint.id, msg[0]);
                if let Some(handler) = handler {
    ...
    fn handle_event(self: Rc<Self>, msg: &[u32], fds: &mut VecDeque<Rc<OwnedFd>>) -> Result<(), ObjectError> {
        ...
        match msg[1] & 0xffff {
            0 => {
                ...
                eprintln!("server      -> ext_data_control_offer_v1#{}.offer(mime_type: {:?})", msg[0], arg0);
                if let Some(handler) = handler {
