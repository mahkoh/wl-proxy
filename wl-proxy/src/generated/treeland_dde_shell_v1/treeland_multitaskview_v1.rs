...
/// A treeland_multitaskview_v1 proxy.
///
...
impl ProxyPrivate for TreelandMultitaskviewV1 {
    fn new(state: &Rc<State>, version: u32) -> Rc<Self> {
        Rc::<Self>::new_cyclic(|slf| Self {
            core: ProxyCore::new(state, slf.clone(), ProxyInterface::TreelandMultitaskviewV1, version),
...
impl Proxy for TreelandMultitaskviewV1 {
