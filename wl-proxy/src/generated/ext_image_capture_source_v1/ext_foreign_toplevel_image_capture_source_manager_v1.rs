...
impl MetaExtForeignToplevelImageCaptureSourceManagerV1 {
    ...
    pub fn send_create_source(
        ...
        eprintln!("server      <= ext_foreign_toplevel_image_capture_source_manager_v1#{}.create_source(source: ext_image_capture_source_v1#{}, toplevel_handle: ext_foreign_toplevel_handle_v1#{})", id, arg0_id, arg1_id);
    ...
    pub fn send_destroy(
        ...
        eprintln!("server      <= ext_foreign_toplevel_image_capture_source_manager_v1#{}.destroy()", id);
        let endpoint = &self.core.state.server;
        if !endpoint.has_outgoing.replace(true) {
            self.core.state.flushable_endpoints.borrow_mut().push(endpoint.clone());
        }
    ...
    fn handle_request(self: Rc<Self>, client: &Rc<Client>, msg: &[u32], fds: &mut VecDeque<Rc<OwnedFd>>) -> Result<(), ObjectError> {
        ...
        match msg[1] & 0xffff {
            0 => {
                ...
                eprintln!("client#{:04} -> ext_foreign_toplevel_image_capture_source_manager_v1#{}.create_source(source: ext_image_capture_source_v1#{}, toplevel_handle: ext_foreign_toplevel_handle_v1#{})", client.endpoint.id, msg[0], arg0, arg1);
                let arg0_id = arg0;
            ...
            1 => {
                ...
                eprintln!("client#{:04} -> ext_foreign_toplevel_image_capture_source_manager_v1#{}.destroy()", client.endpoint.id, msg[0]);
                if let Some(handler) = handler {
