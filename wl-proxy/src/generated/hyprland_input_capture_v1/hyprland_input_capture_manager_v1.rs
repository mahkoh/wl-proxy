...
/// A hyprland_input_capture_manager_v1 proxy.
///
...
impl ProxyPrivate for HyprlandInputCaptureManagerV1 {
    fn new(state: &Rc<State>, version: u32) -> Rc<Self> {
        Rc::<Self>::new_cyclic(|slf| Self {
            core: ProxyCore::new(state, slf.clone(), ProxyInterface::HyprlandInputCaptureManagerV1, version),
...
impl Proxy for HyprlandInputCaptureManagerV1 {
