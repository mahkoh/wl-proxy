...
impl MetaZwlrInputInhibitorV1 {
    pub(crate) fn new(state: &Rc<InnerState>, version: u32) -> Rc<Self> {
        Rc::new(Self {
            core: ProxyCore::new(state, ProxyInterface::ZwlrInputInhibitorV1, version),
...
impl MetaZwlrInputInhibitorV1 {
    ...
    pub fn send_destroy(
        ...
        eprintln!("server      <= zwlr_input_inhibitor_v1#{}.destroy()", id);
    ...
    fn handle_request(self: Rc<Self>, client: &Rc<Client>, msg: &[u32], fds: &mut VecDeque<Rc<OwnedFd>>) -> Result<(), ObjectError> {
        ...
        match msg[1] & 0xffff {
            0 => {
                ...
                eprintln!("client#{:04} -> zwlr_input_inhibitor_v1#{}.destroy()", client.endpoint.id, msg[0]);
