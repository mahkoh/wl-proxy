...
impl MetaZxdgExporterV2 {
    ...
    pub fn send_destroy(
        ...
        eprintln!("server      <= zxdg_exporter_v2#{}.destroy()", id);
    ...
    pub fn send_export_toplevel(
        ...
        eprintln!("server      <= zxdg_exporter_v2#{}.export_toplevel(id: zxdg_exported_v2#{}, surface: wl_surface#{})", id, arg0_id, arg1_id);
        let endpoint = &self.core.state.server;
        if !endpoint.has_outgoing.replace(true) {
            self.core.state.flushable_endpoints.borrow_mut().push(endpoint.clone());
        }
    ...
    fn handle_request(self: Rc<Self>, client: &Rc<Client>, msg: &[u32], fds: &mut VecDeque<Rc<OwnedFd>>) -> Result<(), ObjectError> {
        ...
        match msg[1] & 0xffff {
            0 => {
                ...
                eprintln!("client#{:04} -> zxdg_exporter_v2#{}.destroy()", client.endpoint.id, msg[0]);
            ...
            1 => {
                ...
                eprintln!("client#{:04} -> zxdg_exporter_v2#{}.export_toplevel(id: zxdg_exported_v2#{}, surface: wl_surface#{})", client.endpoint.id, msg[0], arg0, arg1);
                let arg0_id = arg0;
